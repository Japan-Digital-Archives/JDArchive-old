...
<h3><a href="http://www9.nhk.or.jp/311shogen/">NHK 東日本大震災アーカイブス</a></h3>
...
<h3><a href="http://www.nhk.or.jp/japan311/">NHK 東日本大震災プロジェクト</a></h3>
  <p>日本放送協会</p>
  <p>日本放送協会ではさらに、全世界に向けた英語によるウェブサイトも提供しています。ここでは、地図情報と共に、複合災害となった東日本大震災の概要や、現在も予断を許さない放射能汚染情報、そして2011年3月以降NHKワールドで放映されたさまざまな映像を閲覧できます。例えば、「Nuclear Watch」というセクションでは原発問題に関するニュースや分析的なドキュメンタリーを、また、「Documenting the Story」というセクションでは主に被災者の復興への活動や感動的なエピソードなどを視聴できます。さらに、「People's Voices」のセクションでは、全世界から寄せられた励ましのメッセージや被災者が書いたブログや手紙などを英語でご覧いただけます。</p>
  <br />
