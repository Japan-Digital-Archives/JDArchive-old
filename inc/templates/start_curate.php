...
<div id="wrapper">
  <div id="wrapper-bgtop">
    <div id="header" style="position:fixed; left:50%; margin-left:-490px;">
      <div id="logo">
        <a href="/"><h1><span style="display:none;">Digital Archive</span></h1></a>
       </div>
      <!-- end #logo -->
      <div id="menu">
        <ul>
          ...
          <?php else: ?>
          <li class="current_page_item"><strong data-en="Contribute" data-zh="投稿方法" data-jp="投稿方法" data-ko="제출">Contribute</strong>
          	<ul class="fat">
          		<li><a href="../contribute/" data-en="Website" data-zh="网站" data-jp="ウェブサイト" data-ko="웹사이트">Website</a></li>
          		<li><a href="../testimonial/" data-en="Testimonial" data-zh="我的“日本东北大地震”" data-ko="개인체험수기" data-jp="わたしの「東日本大震災」">Testimonial</a></li>
          	</ul>
    ...
    <!-- end #header-wrapper -->
    <div id="page">
      <div id="bigpage" style="margin-top:98px;">
