...
<p><strong>Eメール <?php echo mailto('submit@jdarchive.org'); ?></strong> - 他の形でオンライン資料を送って頂くことも可能です。例えば、被災地で人々の間に流布された風聞など、やりとりされたEメールを送って下さっても結構ですし、また書類を直接Eメールで送って頂くこともできます。その際、誰が・いつ・どこで作成した記録なのかなど、その出来事の背景となる情報も可能な限り加えて頂ければ幸いです。
