<?php 
class FBW_Activity extends WP_Widget {
	function FBW_Activity() {
		$widget_ops = array('classname' => 'widget_fbw_activity', 'description' => 'The Activity Feed plugin displays the most interesting recent activity taking place on your site.' );
		$this->WP_Widget('fbw_activity', 'Facebook - Activity Feed', $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		echo "<fb:activity site='{$url}' width='{$instance['width']}' height='{$instance['height']}' header='{$header}' colorscheme='{$instance['scheme']}' border-color='{$instance['bordercolor']}'/>";
		?>
			<script>
